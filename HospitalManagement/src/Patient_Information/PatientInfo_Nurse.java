...
public class PatientInfo_Nurse extends JPanel {
    ...
    public PatientInfo_Nurse(){
       ...
       //patient profile card
        ...
        Image imgScaled = img.getImage().getScaledInstance(140, 140, Image.SCALE_SMOOTH);
        JLabel pic = new JLabel(new ImageIcon(imgScaled));
        pic.setBounds(10, 15, 140, 140);
        profileCard.add(pic);
        
        JLabel name = new JLabel("Joshua Garcia");
        ...
        JLabel lblAddre = new JLabel("Biñan, Laguna");
        ...
        JLabel lblNum = new JLabel("+63 923 456 789");
        ...
        JLabel lblNotes = new JLabel("Nurse's Notes");
        ...
        JTextArea notesText = new JTextArea("Patient monitored overnight.\n" 
        ...
        for (String[] row : vitalRows) {
            ...
            val.setFont(new Font("Calibri", Font.PLAIN, 20));
            val.setForeground(darkBlue);
        ...
        JTextArea txtCon = new JTextArea("Contact Name: \n\nRelationship: \n\nContact Number: ");
        ...
        JLabel lblT = new JLabel("9:00 AM");
        ...
        JLabel lblTy = new JLabel("General Checkup");
        ...
        edit.addActionListener(e -> {
            ...
            JTextField txtName = new JTextField("Joshua Garcia");
